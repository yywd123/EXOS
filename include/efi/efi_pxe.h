...
#define PXE_UINT64_SUPPORT          1   // uint64_t supported
//#define PXE_NO_UINT64_SUPPORT     1   // uint64_t not supported
...
typedef unsigned const char PXE_UINT8;
