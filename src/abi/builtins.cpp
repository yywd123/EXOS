 ...
 */
void *
__builtin_memcpy(void *s1, const void *s2, size_t n) {
...
void *
__builtin_memmove(void *dest, const void *src, size_t n) {
...
int
__builtin_memcmp(const void *buf1, const void *buf2, unsigned long size) {
	size_t i = 0;
...
void *
__builtin_memset(void *p, int data, size_t size) {
